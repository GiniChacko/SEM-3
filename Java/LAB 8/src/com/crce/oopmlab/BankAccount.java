...
public class BankAccount {
	...
	public BankAccount(double initialBalance, int accountNo) {
        ...
        if (initialBalance < 0)
        	throw new IllegalArgumentException("Intial Balance must not be negative");
	...
	public void withdraw(double amount) {
		...
		if(balance < amount)
			throw new IllegalArgumentException("Withdrawal amount must not be less than the balance");
