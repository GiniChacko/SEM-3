...
public class Quotes {
	...
	public static Quote myQuotes[] = new Quote[10];// Array for Storing 10 Quote Objects.
	...
	public static void printQuote(String quoteType) {
		...
		for(int n=0; n< myQuotes.length; n++)
		{
			if(myQuotes[n].getQuoteType().equals(quoteType))
				
				arrayList.add(myQuotes[n]);
		}
		 System.out.println();
		 System.out.println("Total number of " + quoteType + " Messages are " + arrayList.size());
